...
stocklist=pd.read_csv("/home/casey/projects/up/stock-predictor-linreg-sklearn-numpy-flask-app/companylist.csv")

class StockSelection(Form):
#    url=('http://www.nasdaq.com/screening/'
#     'companies-by-industry.aspx?exchange=NASDAQ&render=download')
    stocklist=pd.read_csv(r"/home/casey/projects/up/stock-predictor-linreg-sklearn-numpy-flask-app/companylist.csv")
